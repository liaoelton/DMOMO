...
void writeCurrentElitistArchive( char final )
{
    ...
    if( final )
        ...
        // sprintf( string, "knapsack%d_result/cheat_ims/result%d/elitist_archive_at_evaluation_%d.dat", number_of_parameters, runTimes, number_of_evaluations );
        sprintf( string, "result0/elitist_archive_at_evaluation_%d.dat", number_of_parameters, runTimes, number_of_evaluations );
...
void initializePopulationAndFitnessValues()
{
    ...
    for( i = 0; i < population_size; i++ )
    {
        ...
        std::string a = "0101110110100011111101011001101110010101011111000110110111111110011111011100110100110000110000010001";
        for(j = 0; j < 100; j++){
            population[0][j] = a[j]-'0';
        ...
        printf("%lf, %lf\n", objective_values[0][0], objective_values[0][1]);
    }
}
/**
