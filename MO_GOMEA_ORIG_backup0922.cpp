...
int total_mixing_times = 0;
int total_FI_times = 0;
...
void writeCurrentElitistArchive( char final )
{
    ...
    if( final )
        ...
        // sprintf( string, "knapsack%d_result/doublecheat/result%d/elitist_archive_at_evaluation_%d.dat", number_of_parameters, runTimes, number_of_evaluations );
        sprintf( string, "result0/elitist_archive_at_evaluation_%d.dat", number_of_evaluations );
